extends Node
class_name SShader, "res://addons/godot_sprite_shader/assets/icon/icon_ss.png"
...
func _get_configuration_warning():
	...
	if not self._shader_player:
		warnings.append("%s must be a child of SShaderContainer" % name)
...
func _get_shader_player():
	...
	if parrent is SShaderContainer:
		return parrent
	return null
