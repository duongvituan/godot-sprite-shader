tool
class_name SSMatrixOneColor extends SShader
...
export var chars_tex = preload("res://addons/godot_sprite_shader/assets/noise/chars_texture3x3.png") setget _set_chars_tex
