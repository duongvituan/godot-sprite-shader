...
func start_to_dust():
	if not is_active:
		...
		$Char2/EzShaderPlayer/EzDissolveDust.play(1.0, false)
		$Char2.stop_sprite_animation()
		
		
		# Dissolve with fire
		$Char3/EzShaderPlayer/EzDissolveBurn.play(1.0, false)
		...
		is_active = false
		$Char2/EzShaderPlayer/EzDissolveDust.offset_y = -0.15
		$Char2/EzShaderPlayer/EzDissolveDust.play_reverse(1.0, false)
		$Char2.play_sprite_animation()
		
		$Char3/EzShaderPlayer/EzDissolveBurn.play_reverse(1.0, false)
